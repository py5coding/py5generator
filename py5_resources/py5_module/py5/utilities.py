...
class Py5Utilities:
    ...
    def __init__(self, sketch):
        ...
        try:
            ...
            self._dir = list(set(dir(self._instance)) - set(
                'equals getClass hashCode notify notifyAll wait toString'.split()))
        except:
            self._instance = None
            self._dir = []
    ...
    def __getattr__(self, name):
        if self._instance is None:
            ...
            raise AttributeError(spelling.error_msg(
                'Py5Utilities', name, self._instance))
