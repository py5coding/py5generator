...
/**
 * The below code is a modification of K.jpg's OpenSimplex 2 code. It was
 * released into the public domain with the hope that others would use it to
 * "make cool things, rather than to make patents!" Many thanks to K.jpg for
 * their contribution to the py5 library.
 * 
 * https://github.com/KdotJPG/OpenSimplex2
 * https://github.com/KdotJPG/OpenSimplex2/blob/master/java/OpenSimplex2S.java
 * 
 * This version adds a few array functions to faciliate better performance from
 * Python and py5 via jpype.
 */
...
public class OpenSimplex2S {
  ...
  public double[] noise2Array(double[] x, double[] y) {
    ...
    for (int i = 0; i < x.length; ++i) {
      out[i] = noise2(x[i], y[i]);
    }
    return out;
  }

  public double[] noise3_ClassicArray(double[] x, double[] y, double[] z) {
    double[] out = new double[x.length];
    for (int i = 0; i < x.length; ++i) {
      out[i] = noise3_Classic(x[i], y[i], y[i]);
    }
    return out;
  }

  public double[] noise4_ClassicArray(double[] x, double[] y, double[] z, double[] w) {
    double[] out = new double[x.length];
    for (int i = 0; i < x.length; ++i) {
      out[i] = noise4_Classic(x[i], y[i], y[i], w[i]);
    }
    return out;
  }
  ...
  static {
    ...
    int[][] lookup4DPregen = {
        { 0x15, 0x45, 0x51, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6,
            0xA9, 0xAA },
        ...
        { 0x15, 0x45, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA6, 0xA9, 0xAA, 0xAB,
            0xAE },
        ...
        { 0x15, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAB,
            0xBA },
        { 0x55, 0x56, 0x5A, 0x65, 0x66, 0x6A, 0x96, 0x9A, 0xA6, 0xAA, 0xAB },
        { 0x54, 0x55, 0x59, 0x65, 0x69, 0x6A, 0x95, 0x99, 0xA5, 0xA9, 0xAA },
        { 0x15, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAE,
            0xBA },
        ...
        { 0x45, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAB,
            0xEA },
        { 0x55, 0x56, 0x5A, 0x66, 0x6A, 0x95, 0x96, 0x9A, 0xA6, 0xAA, 0xAB },
        { 0x54, 0x55, 0x59, 0x65, 0x69, 0x95, 0x99, 0x9A, 0xA5, 0xA9, 0xAA },
        { 0x45, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAE,
            0xEA },
        ...
        { 0x51, 0x54, 0x55, 0x56, 0x59, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xBA,
            0xEA },
        ...
        { 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAB, 0xAE,
            0xBA, 0xEA }, };
  ...
  static {
    ...
    Grad3[] grad3 = { new Grad3(-2.22474487139, -2.22474487139, -1.0), new Grad3(-2.22474487139, -2.22474487139, 1.0),
        new Grad3(-3.0862664687972017, -1.1721513422464978, 0.0),
        new Grad3(-1.1721513422464978, -3.0862664687972017, 0.0), new Grad3(-2.22474487139, -1.0, -2.22474487139),
        new Grad3(-2.22474487139, 1.0, -2.22474487139), new Grad3(-1.1721513422464978, 0.0, -3.0862664687972017),
        new Grad3(-3.0862664687972017, 0.0, -1.1721513422464978), new Grad3(-2.22474487139, -1.0, 2.22474487139),
        ...
        new Grad3(-3.0862664687972017, 1.1721513422464978, 0.0), new Grad3(-1.0, -2.22474487139, -2.22474487139),
        new Grad3(1.0, -2.22474487139, -2.22474487139), new Grad3(0.0, -3.0862664687972017, -1.1721513422464978),
        new Grad3(0.0, -1.1721513422464978, -3.0862664687972017), new Grad3(-1.0, -2.22474487139, 2.22474487139),
